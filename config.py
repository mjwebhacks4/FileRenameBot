...
class Config(object):
    ...
    UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "-1001712250223")
    # log channel
    LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001771465683")
    # Get these values from my.telegram.org
    CHAT_ID = os.environ.get("CHAT_ID", "-1001573848869")
